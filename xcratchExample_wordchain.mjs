...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass$1(ExtensionBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
        ...
        blocks: [
          ...
          blockType: BlockType$1.REPORTER,
          blockAllThreads: false,
          text: "start wordchain [TEXT]",
          func: 'wordchain',
          arguments: {
            TEXT: {
                type: "string",
                defaultValue: "start wordchain"
            }
          }
          },{
          ...
          text: formatMessage({
            ...
            default: 'list [LIST] has [WORD]',
            description: 'Check if a list contains duplicate words'
          }),
          func: 'checkHistory',
          arguments: {
            LIST: {
    ...
    value: function wordchain(TEXT) {
      ...
      console.log("==============TEXT: " + TEXT);
      if (TEXT == 'start wordchain' | '{"TEXT":"start wordchain"}') {
      ...
      if (!wordchain.firstCall) {
        ...
        var textToSend = "しりとりをしましょう。単語のみ、ひらがなで返答して下さい。「" + TEXT + "」から始めます。";;
      }
    ...
    value: function checkHistory(args) {
      ...
      // 「。」と「（」で文字列を分割して単語の配列を取得
      //var word = tmp_word.split(/[。（]/).map(function(tmp_word) {
        // 単語の前後の空白を除去
        //return tmp_word.trim();
      //});
