...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass$1(ExtensionBlocks, [{
        ...
        blocks: [{
          ...
          arguments: {
            URL: {
              ...
              defaultValue: "http://localhost/image"
            },
          }
          ...
          blockType: BlockType$1.REPORTER,
          text: formatMessage({
            id: 'extension.create_image',
            default: 'create image of [TEXT]',
            description: 'show image'
          }),
          func: 'createImage',
          arguments: {
            TEXT: {
                type: "string",
                defaultValue: "create an image of cat"
            }
          }
          ...
          blockType: BlockType$1.REPORTER,
          text: formatMessage({
            id: 'extension.get_image',
            default: 'get image from [URL]',
          ...
          arguments: {
            ...
            /*  ######NG!: type: "image" is not recognized
            IMAGE: {
                type: "image",
        ...
        var checkExist = setInterval(function() {
          ...
          if (stage) {
            ...
            imgElement.onload = function() {
              console.log('===========onload: imgElement: ', stage);
              var maxWidth = 200; // 最大幅を設定
              var maxHeight = 200; // 最大高さを設定
              ...
              imgElement.style.left = "10px"; // 画像の左端の位置を調整する必要があります
              imgElement.style.top = "10px"; // 画像の上端の位置を調整する必要があります
              stage.appendChild(imgElement);
              console.log('===========appended child to stage: ', stage);
              
              resolve();
            };
            console.log('===========onload finished');
            imgElement.src = imageURL;   //image;
          }
        });          
      });
    }
    ...
    key: "createImage",
    value: function createImage(args) {
      console.log("args: " + args);
      
      //const server2Url = 'http://43.207.104.22:8000/chatgpt/'; 
      const server2Url = 'https://www.tadaumi.com/xcratch_dalle/';
      var textToSend = args.TEXT;
    ...
    value: function getImage(args) {
      ...
      async function getImageData(url) {
          try {
              const proxyUrl = `http://localhost/proxy/?url=${url}`;
