...
export default class HandposeExtension {
  constructor (runtime) {
...
class Scratch3Handpose2ScratchBlocks {
    ...
    */
    ...
    videoToggle (args) {
     ...
     // A scratch command block handle that configures the video preview'sexport default
...
export default Scratch3Handpose2ScratchBlocks;
