          ...
          const predictLoop = async () => {
            if (model && video.elt.readyState === 4) {
              ...
              if (hands.length > 0) {
                ...
                self.landmarks = hands[0].keypoints.map(kp => [kp.x, kp.y]);
