...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass$1(ExtensionBlocks, [{
      ...
      return {
        ...
        blocks: [
          // 新しいブロックを追加
          {
            ...
            text: formatMessage({
              id: 'xcratchExample.generateText',
              default: 'generate text with GPT [TEXT]',
    ...
    key: "generateText",
    value: async function generateText(args) {
      var inputText = Cast$1.toString(args.TEXT);
      try {
      	return "Generated text: " + inputText;
      	/*
