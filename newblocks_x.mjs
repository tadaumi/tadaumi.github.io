...
var en$1 = {
	"newblocks.entry.name": "newblocks",
	"newblocks.entry.description": "Description of this extension"
};
var ja$1 = {
	"newblocks.entry.name": "newblocks",
	"newblocks.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"newblocks.entry.name": "newblocks",
	"newblocks.entry.description": "かくちょうきのうのせつめい"
}
};
...
var entry = {
  get name() {
    return formatMessage$1({
      id: 'newblocks.entry.name',
      default: 'newblocks',
      description: 'name of the extension'
    });
  },
  extensionId: 'newblocks',
  extensionURL: 'https://tadaumi-hitoshi@amail.plala.or.jp.github.io/tadaumi/dist/newblocks.mjs',
  collaborator: 'tadaumi-hitoshi@amail.plala.or.jp',
  iconURL: img$2,
  insetIconURL: img$1,
  get description() {
    return formatMessage$1({
      ...
      id: 'newblocks.entry.description'
    });
  },
  featured: true,
  disabled: false,
  ...
  helpLink: 'https://tadaumi-hitoshi@amail.plala.or.jp.github.io/tadaumi/',
...
var en = {
	"newblocks.name": "newblocks",
	"newblocks.doIt": "do it [SCRIPT]"
};
var ja = {
	"newblocks.name": "newblocks",
	"newblocks.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
 ...
 * @type {string}
 */
var extensionURL = 'https://tadaumi-hitoshi@amail.plala.or.jp.github.io/tadaumi/dist/newblocks.mjs';
...
var ExtensionBlocks = /*#__PURE__*/function () {
  /**
   * Construct a set of blocks for newblocks.
